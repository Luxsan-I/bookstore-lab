...
class BookstoreArrayListTest {
    ...
    @NullAndEmptySource
    @ValueSource
    void testFindByInvalidIsbn(String var1) {
        throw new Error("Unresolved compilation problem: \n\tParameterizedTest cannot be resolved to a type\n");
    }
    ...
    @ParameterizedTest
    @NullAndEmptySource
    void testRemoveInvalidIsbn(String var1) {
        throw new Error("Unresolved compilation problem: \n\tParameterizedTest cannot be resolved to a type\n");
    }
    ...
    @ParameterizedTest
    @NullAndEmptySource
    void testFindByInvalidTitle(String var1) {
        throw new Error("Unresolved compilation problem: \n\tParameterizedTest cannot be resolved to a type\n");
    }
