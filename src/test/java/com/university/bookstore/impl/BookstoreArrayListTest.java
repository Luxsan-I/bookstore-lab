...
class BookstoreArrayListTest {
    ...
    /**
    *Declare a variable for the bookstore object under test
    *Each test will work with a fresh instance of this object
     */
    private BookstoreArrayList bookstore;

    /**
     * Declares several Book variables that will be reused in multiple tests
     */
